...
const HeroSection = () => {
  ...
  const socialLinks = [
    ...
    { icon: "gitlab", url: "https://about.gitlab.com/", label: "GitLab" },
  ];
    ...
    <section className="relative min-h-screen flex items-center overflow-hidden" id="home">
      ...
      <div className="container relative z-10">
        <div className="grid lg:grid-cols-3 gap-8 items-center">
          ...
          >
            <span className="text-primary text-lg font-medium block">Creative</span>
            <h2 className="font-display text-3xl lg:text-4xl font-bold leading-tight">
              <span className="bg-gradient-to-r from-primary to-primary-light bg-clip-text text-transparent">Developer</span>
              <br />
