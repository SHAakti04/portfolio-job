    ...
    <section id="home" className="relative min-h-screen flex items-center">
      ...
      <div className="container relative z-10 py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-16 items-center">
            ...
            <div className="flex flex-col gap-4 pt-6 items-center xl:items-start">
              {socialLinks.map((social) => (
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label={social.label}
                  className="w-10 h-10 flex items-center justify-center rounded-full border border-muted-foreground/30
                             text-muted-foreground hover:text-primary hover:border-primary transition hover:scale-110"
                >
                  <SocialIcon name={social.icon} />
                </a>
              ))}
          ...
          <div className="flex justify-center">
            <div className="relative">
              ...
              <img
                src={profileImg}
                alt="Shaktikumar Prajapati"
                className="relative w-56 sm:w-64 lg:w-72 xl:w-80 rounded-b-full"
                style={{
          ...
          {/* RIGHT */}
          <div className="text-center xl:text-right space-y-5">
            <span className="text-primary text-lg font-medium">
              Logical Developer
            </span>
...
const SocialIcon = ({ name }: { name: string }) => {
  const icons: Record<string, JSX.Element> = {
    ...
    github: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        <path d="M12 0C5.37 0 0 5.37 0 12c0 5.3 3.44 9.8 8.21 11.39" />
      </svg>
    ),
    leetcode: (
      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
        <path d="M13.48 2.82l-6.6 6.6a3.39 3.39 0 000 4.8l6.6 6.6" />
      </svg>
    ),
  };
